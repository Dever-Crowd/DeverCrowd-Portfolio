  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label className={labelClass} htmlFor="phoneNumber">Phone</label>
            <input
              id="phoneNumber"
              type="tel"
              name="phoneNumber"
          ...
          <div>
            <label className={labelClass} htmlFor="title">Your Title</label>
            <input
              id="title"
              type="text"
              name="title"
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label className={labelClass} htmlFor="knownBy">How did you find us?</label>
          ...
          <div>
            <label className={labelClass} htmlFor="requestedServices">Service needed</label>
