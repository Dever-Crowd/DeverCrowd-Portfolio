...
type H1Variant = "default" | "muted" | "small";

const variants: Record<H1Variant, string> = {
  default:
    "text-2xl md:text-3xl font-extrabold capitalize text-transparent bg-gradient-to-r from-primary to-accent bg-clip-text animate-gradient bg-[length:200%_200%] tracking-tight drop-shadow-[0_1px_2px_primary]",
  muted:
...
const H1 = React.forwardRef<HTMLElement, H1Props>(function H1(
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center text-center py-6">
      ...
      <div className="mt-4 w-3/4 sm:w-2/3 md:w-1/2 lg:w-[40%] h-[3px] bg-gradient-to-r from-transparent via-primary to-transparent rounded-full shadow-md shadow-primary/30" />
    </div>
  );
});
